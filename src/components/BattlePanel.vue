<template>
  <div class="space-y-6" :class="{ 'animate-screen-shake': screenShaking }">
    ...
    <!-- 空报告提示 -->
    <div v-else class="rounded-xl border p-6 text-center" style="border-color: var(--border); background: rgba(255,255,255,0.02);">
      <div class="text-2xl mb-2">🌑</div>
      <div class="text-sm text-[var(--text2)]">暂无战斗记录</div>
      <div class="text-xs text-[var(--text3)] mt-1">点击上方“立即战斗”开始第一场冒险</div>
    </div>
  </div>
</template>
